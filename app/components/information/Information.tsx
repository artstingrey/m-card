...
export default function Information () {
    ...
    const faqList = [
        {
            q: "Может ли моя карта быть заблокирована?",
            a: "Да, вы можете мгновенно заморозить карту через Telegram-бота, если потеряли её или заметили необычную активность."
        },
        {
            q: "Можно ли вывести средства?",
            a: "Да, вы можете мгновенно заморозить карту через Telegram-бота, если потеряли её или заметили необычную активность."
        },
        {
    ...
    return (
        <section className={clsx("section-v-gap-40-112", styles.information)}>
