...
type QrButtonProps = {
    isSmall?: boolean;
    color?: "" | "white-transparent" | "white" | "black-transparent";
    clickEvent?: React.MouseEventHandler<HTMLButtonElement>;
    mouseEnter?: () => void;
    mouseLeave?: () => void;
}

export default function QrButton ({isSmall = false, color = '', clickEvent, mouseEnter, mouseLeave}:QrButtonProps) {
    const colorClass = color == '' ? '' : 'qr-button--' + color;

    return (
        <button className={clsx("qr-button",isSmall ? "qr-button--small" : "", colorClass)} onClick={clickEvent} onMouseEnter={mouseEnter} onMouseLeave={mouseLeave}>
