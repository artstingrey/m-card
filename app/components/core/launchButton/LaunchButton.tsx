...
export default function LaunchButton ({text, styles, typeButton = "", color = "black"}:LaunchButtonType) {
    return (
        <div className={clsx(styles, "s-button-launch-wrapper")}>
            <a href="#" className={clsx("s-button", typeButton == "full" ? "s-button--full" : "", color == "white" ? "s-button--white" : "")}>{text}</a>
            <button className={clsx("qr-button", color == "white" ? "qr-button--white" : "")}>
