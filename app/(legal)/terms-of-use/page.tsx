  ...
  return (
    <main role="main" className="text-page">
        ...
        <article className="text-content">
            <h2>Heading 2</h2>
            <p><b>Dolor enim eu tortor urna sed duis nulla. Aliquam vestibulum, nulla odio nisl vitae. In aliquet pellentesque aenean hac vestibulum turpis mi bibendum diam. Tempor integer aliquam in vitae malesuada fringilla.</b></p>
